...
//		std::cout<<"road:"<<road<<",";
	...
	//新增RSU测试
	const Coord  a(0,0);
	const Coord  b(700,700);

	addModule("RSU0", moduleType, moduleName, moduleDisplayString,a,road,0,0);
    addModule("RSU1", moduleType, moduleName, moduleDisplayString,b,road,0,0);
...
//	EV<<"addmod:"<<nodeVectorIndex<<endl;
